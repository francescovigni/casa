...
·
<a href="mailto:hello@francescovigni.com" class="underline-offset-2 hover:underline">hello@francescovigni.com</a> </p> </div> <nav class="flex flex-wrap gap-x-5 gap-y-2 text-sm" aria-label="Elsewhere"> ${links.map((l) => renderTemplate`<a${addAttribute(l.href, "href")} rel="me noopener" target="_blank" class="text-muted transition-colors hover:text-ink"> ${l.label} </a>`)} </nav> </div> </footer>`;
