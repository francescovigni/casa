...
const insights = [
  {
    ...
    body: {
      en: [
        { type: "p", text: "The European Health Data Space (EHDS) regulation reshapes how health data can be used for research and AI across the EU. For a hospital starting an AI project, EHDS is not a future compliance problem. It is a present design constraint, and getting the data foundation right early is far cheaper than retrofitting it." },
        ...
        { type: "ul", items: [
          "A clear, documented purpose for every dataset, since secondary use must be specific and lawful.",
          ...
          "A secure processing environment, so training and experimentation happen where the data is governed, not on ad-hoc laptops or unmanaged cloud buckets.",
          "Access control and audit logs: who touched the data, when, and why.",
          "A data governance owner on the hospital side, because EHDS readiness is an organisational role, not just a technical setting.",
        ] },
      ...
      it: [
        ...
        { type: "ul", items: [
          "Una finalità chiara e documentata per ogni dataset, poiché l'uso secondario deve essere specifico e lecito.",
          ...
          "Un ambiente di elaborazione sicuro, così che training ed esperimenti avvengano dove i dati sono governati, non su laptop personali o bucket cloud non gestiti.",
          "Controllo degli accessi e log di audit: chi ha toccato i dati, quando e perché.",
          "Un responsabile della data governance dal lato ospedale, perché la preparazione all'EHDS è un ruolo organizzativo, non solo un'impostazione tecnica.",
        ] },
  ...
  },
  {
    ...
    summary: {
      en: "Most clinical-AI pilots that stall at validation were never wrong about the model. They were designed in a way validation could not survive, and the failures are predictable.",
