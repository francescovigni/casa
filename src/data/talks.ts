// Talks and interviews, ported from the Gatsby site. Titles and venues stay in
// their original language: two of these were delivered in Italian.
//
// They do double duty. The conference talks (ICRA, RO-MAN, HRI) are research
// presence with a face on it; the broadcast interview and the school talk show
// the same work explained to a non-technical room.

export interface Talk {
  title: string;
  event: string;
  /** "Mon YYYY", English, rendered as-is. */
  date: string;
  description: string;
  youtubeId: string;
}
...
export const talks: Talk[] = [
  ...
  },
  {
    ...
    date: "Aug 2024",
    description: "A study on emotion-adapted proxemics behaviours.",
