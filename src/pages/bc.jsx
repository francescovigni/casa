...
const pills = ["Medical AI", "Computer Vision", "EHDS", "HRI Research", "Edge AI"];
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div>
            ...
            <p className="text-primary-600 font-medium mt-1">Medical AI Consultant</p>
